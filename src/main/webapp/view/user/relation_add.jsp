...
<div class="pageContent">
    <a style="display: none;" id="customerPersonerBack"
       ...
       height="500"
       title="添加亲属关系" maxable="false"></a>

    <form method="post" action="<%=request.getContextPath()%>/userManage/relation/add"
        ...
        <div class="pageFormContent" layoutH="56">
            ...
            <p>
                <label>关系：</label>
                <input name="relation" type="text" class="required"/>
            </p>

            <p>
                <label>用户的id：</label>
                <input name="userId" value="${uid}" readonly="readonly">
            </p>
            <%--<input name="userId" value="${uid}" hidden>--%>
